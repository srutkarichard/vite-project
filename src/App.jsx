...
function typeSort(props){
  cardSrc = `/vite-project/img/cardBackground/${props}.png`
  return cardSrc
}
    ...
    { 
      ...
      return (
        <div >
          ...
          <img className='pokemonSprite' src={`/vite-project/img/pokemonSprites/${pokemon.pokedexNumber}.png`} onClick={() => onClick(pokemon.pokedexNumber)} style={{zIndex : indx}}/>
